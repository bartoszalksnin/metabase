(ns metabase.driver.dynamodb
  ...
  (:require [cheshire.core :as json]
            ...
            [metabase.driver.dynamodb
             [util :refer [with-dynamodb-connection]]]
...
(defn- can-connect? [details]
  (println "can connnect? with dynamo" details)
...
(defn -init-driver
  "Register the DynamoDB driver"
  []
  (driver/register-driver! :dynamodb (DynamodbDriver.)))
